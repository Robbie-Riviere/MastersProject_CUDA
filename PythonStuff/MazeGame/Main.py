...
# Date: 11/16/2024
# Description:
''' This is a tester program for the Maze Net concept. It is a simple maze game that will generate random mazes
    For the player to solve. Several metrics will be tracked to determine the efficiency of the maze net. The end
    goal of the project is to implement a network capable of classifying difficulty of mazes and suggesting changes
       ...
       while self.running:
           ...
           if event.type == pygame.KEYDOWN:
               if not self.game_over:
                   ...
                   player.check_move(tile, maze.grid_cells, maze.size)
